        ...
        inline namespace cons {
            ...
            template <typename ValueType, typename VarType, typename = std::enable_if_t<adl::oct::common_var<VarType>::is_oct_space>>
                constexpr adl::oct::basic_oct_cons<ValueType, VarType> operator>=(
                    typename adl::oct::basic_oct_vexpr<VarType> vexpr, ValueType rhs) noexcept;
            ...
            template <typename ValueType, typename VarType, typename = std::enable_if_t<adl::oct::common_var<VarType>::is_oct_space>>
                constexpr adl::oct::common_cons_t<ValueType, VarType> operator<=(
                    adl::oct::basic_oct_vexpr<VarType> vexpr, ValueType rhs) noexcept;
...
template <typename ValueType, typename VarType>
constexpr basic_oct_cons<ValueType, VarType>::operator octdiff_conjunction_type() const noexcept {
    return split();
}
...
inline namespace cons {
    ...
    constexpr adl::oct::basic_oct_cons<ValueType, VarType> operator>=(VarType var, ValueType rhs) noexcept {
        return adl::oct::basic_oct_cons<ValueType, VarType>::make_lower_limit(var, rhs);
    }

    template <typename ValueType, typename VarType, typename>
    constexpr adl::oct::basic_oct_cons<ValueType, VarType> operator>=(
        typename adl::oct::basic_oct_vexpr<VarType> vexpr,
        ValueType rhs
    ) noexcept {
        return adl::oct::basic_oct_cons<ValueType, VarType>::make_lower_limit(vexpr, rhs);
    }

    template <typename ValueType, typename VarType, typename>
    constexpr adl::oct::basic_oct_cons<ValueType, VarType> operator<=(VarType var, ValueType rhs) noexcept {
        return adl::oct::basic_oct_cons<ValueType, VarType>::make_upper_limit(var, rhs);
    };
...
inline namespace comparison {
    ...
    constexpr bool operator<(
        adl::oct::basic_oct_cons<ValueType, VarType> const& lhs,
        adl::oct::basic_oct_cons<ValueType, VarType> const& rhs
    ) noexcept {
        return lhs.compare(rhs) < 0;
    }
    ...
    template <typename ValueType, typename VarType, typename>
    constexpr bool operator<(
        adl::oct::basic_octdiff_cons<ValueType, VarType> const& lhs,
        adl::oct::basic_octdiff_cons<ValueType, VarType> const& rhs
    ) noexcept {
        return lhs.compare(rhs) < 0;
    }
    ...
    template <typename ValueType, typename VarType, typename>
    constexpr bool operator<(
        adl::oct::basic_octdiff_conjunction<ValueType, VarType> const& lhs,
        adl::oct::basic_octdiff_conjunction<ValueType, VarType> const& rhs
    ) noexcept {
        return lhs.compare(rhs) < 0;
    }
