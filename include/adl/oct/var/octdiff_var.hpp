...
struct adl_CLASS var_traits<octdiff_var> {
    ...
    template <typename ValueType> using cons_type = basic_octdiff_cons<ValueType, var_type>;
    template <typename ValueType> using counterpart_cons_type = basic_oct_cons<ValueType, counterpart_var_type>;
    template <typename ValueType> using identity_cons_type = basic_octdiff_cons<ValueType, identity_var_type>;
    template <typename ValueType> using octdiff_conjunction_type = basic_octdiff_conjunction<ValueType, var_type>;
