...
#define adl_CONFIG_VERSION_MINOR 1
...
#define adl_CONFIG_COMPILER_IS_GCC (adl_CONFIG_COMPILER_DETECTED == adl_CONFIG_COMPILER_MSVC)
#define adl_CONFIG_COMPILER_IS_CLANG (adl_CONFIG_COMPILER_DETECTED == adl_CONFIG_COMPILER_MSVC)
